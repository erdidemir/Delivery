...
namespace Delivery.Application.Services.Commons
{
    ...
    public static class QueryableExtensions
    {
        ...
        /// <typeparam name="T">Type</typeparam>
        /// <param name="queryable">Collection</param>
        /// <param name="sortItem">Sort parameter</param>
        /// <returns>Result</returns>
        public static IQueryable<T> Sort<T>(this IQueryable<T> queryable, Sort sortItem)
        {
            if (sortItem != null)
            {
                // Use the OrderBy method of Dynamic Linq to sort the data
                return queryable.OrderBy(sortItem.ToExpression());
            }
